...
class IncategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incategory" do
    assert_difference('Incategory.count') do
      post incategories_url, params: { incategory: { desc: @incategory.desc, name: @incategory.name } }
    end
  ...
  test "should update incategory" do
    patch incategory_url(@incategory), params: { incategory: { desc: @incategory.desc, name: @incategory.name } }
